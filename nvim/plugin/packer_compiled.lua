...
_G.packer_plugins = {
  ...
  nerdcommenter = {
    loaded = true,
    path = "/home/anthony/.local/share/nvim/site/pack/packer/start/nerdcommenter",
  ...
  ["oceanic-next"] = {
    loaded = true,
    path = "/home/anthony/.local/share/nvim/site/pack/packer/start/oceanic-next",
  ...
  ["vim-go"] = {
    loaded = true,
    path = "/home/anthony/.local/share/nvim/site/pack/packer/start/vim-go",
